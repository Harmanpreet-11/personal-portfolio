          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <p className="text-gray-400 mb-4">
               Developed a front-end web application to replicate the core functionality of the Spotify music player. 
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {["HTML", "CSS","JavaScript",, "DOM Manipulation"].map((tech, key) => (
                  <span
                    key={key}
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/Harmanpreet-11/Spotify_Clone"
                  target="_blank"
            ...
            "
            >
              <h3 className="text-xl font-bold mb-2">Face Mask Detector</h3>
              <p className="text-gray-400 mb-4">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {["Python", "TensorFlow", "CNN", "Keras"].map((tech, key) => (
                  <span
                    key={key}
                    className="
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/Harmanpreet-11/Face-Mask-Detector"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-400 hover:text-blue-300 transition-colors my-4"
                >
            ...
            >
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/Harmanpreet-11/yt-autopause"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-400 hover:text-blue-300 transition-colors my-4"
                >
            ...
            >
              ...
              <div className="flex justify-between items-center ">
                <a
                  href="https://github.com/Harmanpreet-11/personal-portfolio"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-400 hover:text-blue-300 transition-colors my-4"
                >
